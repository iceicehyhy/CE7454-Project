...
parser.add_argument('--steps_3', type=int, default=5000)
parser.add_argument('--snaperiod_1', type=int, default=1000)
parser.add_argument('--snaperiod_2', type=int, default=1000)
parser.add_argument('--snaperiod_3', type=int, default=1000)
parser.add_argument('--max_holes', type=int, default=2)
...
parser.add_argument('--cn_input_size', type=int, default=128)
